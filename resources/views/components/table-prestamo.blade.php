<tr>
    <td class="border-b border-beig dark:beig p-4 pl-8 text-lila-fosc"> {{$prestamo->user_id}}</td>
    <td class="border-b border-beig dark:beig p-4 pl-8 text-lila-fosc"> {{$prestamo->book_id}}</td>
    <td class="border-b border-beig dark:beig p-4 pl-8 text-lila-fosc"> {{$prestamo->fecha_prestamo}}</td>
    <td class="border-b border-beig dark:beig p-4 pl-8 text-lila-fosc">{{$prestamo->fecha_devolucion}}</td>
    <td class="border-b border-beig dark:beig p-4 pl-8 text-lila-fosc">
        <a href="http://127.0.0.1:8000/updatePrestamoForm/{{$prestamo->id}}"> 
        ...
        <a href="http://127.0.0.1:8000/deletePrestamo/{{$prestamo->id}}"> 
            <button class="inline-flex items-center gap-2 rounded-md bg-beig px-3 py-2 text-sm font-semibold text-lila-fosc border-beig hover:bg-gray-50"> 
