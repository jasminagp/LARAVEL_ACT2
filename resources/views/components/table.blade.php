<tr>
    <td class="border-b border-beig dark:beig p-4 pl-8 text-lila-fosc">{{$libro->titulo}}</td>
    <td class="border-b border-beig dark:beig p-4 pl-8 text-lila-fosc">{{$libro->autor}}</td>
    <td class="border-b border-beig dark:beig p-4 pl-8 text-lila-fosc">{{$libro->genero}}</td>
    <td class="border-b border-beig dark:beig p-4 pl-8 text-lila-fosc">{{$libro->año_publicacion}}</td>
    <td class="border-b border-beig dark:beig p-4 pl-8 text-lila-fosc">{{$libro->disponible}}</td>
